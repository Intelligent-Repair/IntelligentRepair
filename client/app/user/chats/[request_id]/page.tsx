 ...
 * 
 * It will display:
 * - Message history between the user and the garage
 * - Real-time message updates
 * - Message input field with send functionality
 * - Timestamps for each message
 */
export default function UserChatDetailPage({ params }: ChatPageProps) {
    ...
    <div className="bg-transparent text-white h-full flex flex-col">
      ...
      ">
        ...
        <div className="p-6 border-b border-white/10">
          <h1 className="text-2xl font-bold text-white">שיחה - {request_id}</h1>
