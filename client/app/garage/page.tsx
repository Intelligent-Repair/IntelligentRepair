...
export default function GaragePage() {
  ...
  const cards = [
    {
      ...
      subtitle: "צפה בנתונים וסטטיסטיקות",
      icon: BarChart3,
    ...
    {
      title: "פניות לקוחות",
      subtitle: "צפה וטפל בפניות לקוחות",
      icon: Inbox,
  ...
  return (
    <div dir="rtl" className="bg-transparent text-white min-h-screen flex flex-col items-center justify-center container mx-auto px-6 py-20">
      {/* Logo Section */}
