...
- אם אין מספיק מידע → צור שאלה חדשה עם עד 5 אפשרויות תשובה
- השאלה חייבת להיות קצרה, בעברית, ללא שם רכב / דגם.
- אם השאלה היא כן/לא → השאר options כ-null או ["כן", "לא"]
- אם השאלה היא רב-ברירה → הוסף options עם 3-5 אפשרויות

החזר JSON בלבד:
{
 "should_finish": boolean,
 "confidence": number,
 "next_question": "שאלה בעברית" | null,
 "options": ["אפשרות 1", "אפשרות 2", ...] | null,
 "final_diagnosis": {
    "diagnosis":[ "..."],
    "self_checks":[ "..."],
    "warnings":[ "..."],
