...
## סכימת JSON (חובה להחזיר בדיוק בפורמט הזה)
{
  "userDiagnosis": {
    ...
    "confidence": "(מספר בין 0.50 ל-0.95 - קבע לפי כמות המידע: מעט מידע=0.50-0.65, מידע בינוני=0.65-0.80, הרבה פרטים=0.80-0.95)",
    "confidenceLevel": "low|medium|high (low אם confidence<0.60, medium אם 0.60-0.79, high אם >=0.80)",
  ...
  "mechanicSummary": {
    ...
    "diagnoses": [
      {"issue": "אבחון ראשי עם הסבר טכני קצר", "probability": "(מספר בין 0.50 ל-0.90 - גבוה יותר אם יש הרבה תסמינים תואמים)"},
      {"issue": "אבחון משני אפשרי", "probability": "(יתרת האחוזים - סכום כל האבחנות צריך להיות עד 1.0)"}
    ],
    "recommendedActions": [
      "בדיקה טכנית מקצועית 1",
      "בדיקה טכנית מקצועית 2",
      "בדיקה טכנית מקצועית 3"
    ],
    "needsTow": false,
    "urgency": "low|medium|high|critical"
  }
...
## ⚠️ הנחיות קריטיות ל-recommendedActions:
recommendedActions הן פעולות למכונאים מקצועיים בלבד! לא ללקוח!

❌ אסור לכתוב המלצות ללקוח כמו:
- "אל תמשיך בנסיעה"
- "בדוק את מפלס השמן"
- "פנה למוסך"

✅ כתוב פעולות אבחון מקצועיות למכונאי:
- "בדוק לחץ שמן עם מד מקצועי בעת סיבוב סרק"
- "בדוק תקינות חיישן לחץ השמן והחיווט שלו"
- "בדוק משאבת שמן לשחיקה ונזילות"
- "מדוד מפלס והגדרת OBD לקודי תקלה"
- "בצע בדיקת דחיסה למגלה בעיות בלבוש גלילים"
- "בדוק מסננת שמן ואטמי מכסי שסתומים"

דוגמאות לפי סוג תקלה:
- נורת שמן: "בדוק לחץ שמן במד מקצועי", "בדוק חיישן לחץ שמן", "בדוק משאבת שמן", "בדוק מסננת שמן"
- נורת מנוע: "קרא קודי תקלה ב-OBD", "בדוק מערכת פליטה", "בדוק חיישני חמצן"
- רעש בהגה: "בדוק קצות מוטות היגוי", "בדוק משאבת הגה כוח", "בדוק רמת נוזל הגה"
- חימום יתר: "בדוק משאבת מים", "בדוק תרמוסטט", "בדוק רדיאטור לסתימות"
